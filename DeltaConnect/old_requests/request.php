...
if ($f) {
	...
	$textFlightInfo = popen($pythonSMS . '"'. $flightHeader . ". You will depart at " . $departTime . " and arrive at " . $arriveTime . ". Your chances of making first class are " . number_format($flightProb, 2) . "% and of first class " . number_format($firstclassProb, 2) . "%. Bueno suerte!" . '"' . ' ' . $phoneToText, 'r');
